...
public class AllySkillHandler : BaseSkillHandler
{
    [SerializeField]
    private List<SkillData> _skillDataList; // 이 리스트에 아군 유닛이 사용할 스킬 데이터를 할당해주세요.
    ...
    protected override SkillBase CreateSpecificSkillInstance(SkillData skillData)
    {
        ...
        {
            // TODO: AllySkill에 맞는 스킬 타입들을 여기에 추가합니다.
            // 예시:
            // case ESkillType.Heal:
            //     return new AllyHealSkill(skillData, this);
            default:
                Debug.LogError($"Unknown or unsupported Ally Skill Type: {skillData.skillType}");
                return null;
        }
    }
}